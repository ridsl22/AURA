...
namespace Metrom.AURA.Base
{
  ...
  [Flags]
  public enum CEMConfigFlag : ushort
  {
  ...
  public class CEMConfig
  {
   public const ushort kCEMConfigSize = 92;
		...
		public uint DualAURADisableAddr
		{ get; set; }
		...
		public CEMConfig(byte[] buf, ushort ofs, ushort len)
		{
			if (buf == null)
			...
			Flags = (CEMConfigFlag)BitConverter.ToUInt16(buf, ndx);
			ndx += 2;
			...
			DualAURADisableAddr =  BitConverter.ToUInt32(buf, ndx);
